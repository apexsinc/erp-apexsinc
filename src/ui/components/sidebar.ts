  ...
  return `
    <aside class="sidebar">
      ...
      <nav class="sidebar-menu">
        ...
        <a class="nav-item" data-tab="directory" onclick="switchTab('directory')">
        ...
        <a class="nav-item" data-tab="inbound" onclick="switchTab('inbound')">
        ...
        <a class="nav-item" data-tab="outbound" onclick="switchTab('outbound')">
        ...
        <a class="nav-item" data-tab="admin" onclick="switchTab('admin')">
